...
export const quiz: QuizStateType[] = [
  ...
  },
  {
    ...
    options: [
      { id: 1, answer: 'Модульный синтаксис JavaScript', correct: false },
      {
        id: 2,
        answer:
          'Расширение синтаксиса JavaScript, позволяющее использовать HTML-подобный синтаксис в React',
        correct: true,
      },
      {
        id: 3,
        answer: 'Функция в React, которая отвечает за вывод компонентов',
        correct: false,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: 3,
        answer: 'const MyComponent = React.createFunctionComponent(...)',
        correct: false,
      },
    ],
  },
  ...
  },
  {
    ...
    options: [
      {
        id: 1,
        answer: "const element = <div class='my-class' /> ",
        correct: false,
      },
      {
        id: 2,
      ...
      {
        id: 3,
        answer: "const element = <div class='my-class'></div>",
        correct: false,
      },
    ],
  },
  {
    ...
    options: [
      {
        id: 1,
        answer: 'Объект, содержащий состояние компонента',
        correct: true,
      },
      {
        id: 2,
        answer: 'Функция, которая обрабатывает изменения состояния',
        correct: false,
      },
      {
        id: 3,
        answer: 'Свойство, которое определяет, должен ли компонент рендериться',
        correct: false,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: 2,
        answer: 'const newState = {...}; this.state = newState;',
        correct: false,
      },
  ...
  },
  {
    ...
    options: [
      {
        id: 1,
        answer: 'Функция, которая вызывается при каждом рендере компонента',
        correct: false,
      },
      {
        id: 2,
        answer:
          'Хук, который позволяет добавлять эффекты (например, загрузку данных) при монтировании, обновлении и размонтировании компонента',
        correct: true,
      },
      {
        id: 3,
        answer: 'Метод, который вызывается перед рендерингом компонента',
        correct: false,
      },
    ],
  },
    ...
    options: [
      {
        id: 1,
        answer:
          'Статически типизированный язык программирования, который является надмножеством JavaScript',
        correct: true,
      },
      {
        id: 2,
        answer: 'База данных, используемая для хранения данных веб-приложений',
        correct: false,
      },
      {
        id: 3,
        answer: 'Библиотека для работы с асинхронными операциями',
        correct: false,
      },
    ],
  },
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 2,
        answer: 'Функция, которая выполняет определенную задачу',
        correct: false,
      },
      {
        id: 3,
        answer: 'Структура данных, используемая для хранения списков',
        correct: false,
      },
    ],
  },
    ...
    options: [
      {
        id: 1,
        answer:
          'Обобщенные типы данных, которые позволяют создавать универсальные функции и классы',
        correct: true,
      },
      {
        id: 2,
        answer: 'Библиотека для работы с HTTP-запросами',
        correct: false,
      },
      {
        id: 3,
        answer: 'Специальные типы данных, используемые для определения массивов',
        correct: false,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: 2,
        answer: 'const myFunc = (arg1: number, arg2: string): boolean => {...}',
        correct: true,
      },
  ...
  },
  {
    ...
    options: [
      {
        id: 1,
        answer: 'Структура данных, которая хранит ключ-значение',
        correct: false,
      },
      {
        id: 2,
        answer: 'Структура данных, которая хранит набор элементов',
        correct: true,
      },
      {
        id: 3,
    ...
    options: [
      {
        id: 1,
        answer:
          'Метод массива, который позволяет преобразовать каждый элемент массива с помощью функции',
        correct: true,
      },
      {
        id: 2,
        answer: 'Метод массива, который возвращает первый элемент массива',
        correct: false,
      },
      {
        id: 3,
        answer: 'Метод массива, который удаляет последний элемент массива',
        correct: false,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: 2,
        answer: 'const myObj = {key1: value1, key2: value2};',
        correct: false,
      },
      {
        id: 3,
        answer: 'const myObj = new Object({key1: value1, key2: value2});',
        correct: true,
      },
    ],
  },
    ...
    options: [
      {
        id: 1,
        answer:
          'Функции, которые объявлены внутри объекта и могут использоваться для выполнения определенных действий с объектом',
        correct: true,
      },
      {
        id: 2,
        answer: 'Свойства объекта, которые содержат значения',
        correct: false,
      },
      {
        id: 3,
        answer: 'Структуры данных, которые хранят ключ-значение',
        correct: false,
      },
    ],
  },
    ...
    options: [
      {
        id: 1,
        answer:
          'Функции, которые передаются в качестве аргументов другим функциям и вызываются внутри этих функций',
        correct: true,
      },
      {
        id: 2,
        answer: 'Функции, которые вызываются автоматически при определенных событиях',
        correct: false,
      },
      {
        id: 3,
        answer: 'Функции, которые вызывают другие функции',
        correct: false,
      },
    ],
  },
  {
    ...
    options: [
      {
        id: 1,
        answer: 'const myCallback = (arg1, arg2) => {...}',
        correct: true,
      },
      {
        id: 2,
        answer: 'function myCallback(arg1, arg2) {...}',
        correct: false,
      },
      {
        id: 3,
        answer: 'const myCallback = new Function(arg1, arg2, {...})',
        correct: false,
      },
    ],
  },
    ...
    options: [
      {
        id: 1,
        answer:
          'Функции, которые объявлены внутри массива и могут использоваться для выполнения определенных действий с массивом',
        correct: true,
      },
      {
        id: 2,
        answer: 'Свойства массива, которые содержат значения',
        correct: false,
      },
      {
        id: 3,
    ...
    options: [
      {
        id: 1,
        answer:
          'Метод массива, который возвращает новый массив, содержащий элементы, прошедшие проверку с помощью функции',
        correct: true,
      },
      {
        id: 2,
      ...
      {
        id: 3,
        answer: 'Метод массива, который сортирует элементы по заданному критерию',
        correct: false,
      },
    ],
  },
    ...
    options: [
      {
        id: 1,
        answer:
          'Метод массива, который применяет функцию к каждому элементу массива, последовательно уменьшая массив до одного значения',
        correct: true,
      },
      {
        id: 2,
        answer: 'Метод массива, который объединяет два массива в один',
        correct: false,
      },
      {
        id: 3,
        answer: 'Метод массива, который возвращает случайный элемент массива',
        correct: false,
      },
    ],
  },
